...
best_p,dp,t0,detsig,firstpower2,pgrid2,firstphase2,dcyc  = lcfunctions.run_bls_bic(ctarg.data,ctarg.notch.bicstat,ctarg.notch.badflag,rmsclip=1.5,snrcut=7.0,searchmax=15.0,searchmin=10.0)
